...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{dokumentacja_instalacyjno_konfiguracyjna_systemu/images/EnvExample.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{dokumentacja_instalacyjno_konfiguracyjna_systemu/images/Env.png}
    \caption{Konfiguracja zmiennych środowiskowych w IntelliJ IDEA}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{dokumentacja_instalacyjno_konfiguracyjna_systemu/images/Run.png}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=1\linewidth]{dokumentacja_instalacyjno_konfiguracyjna_systemu/images/image.png}
